        ...
        recipes.forEach(recipe => {
            ...
            li.innerHTML = `
                <div class="recipe-card">
                    <img src="images/${recipe.name.toLowerCase().replace(/\s+/g, '-')}.jpg" alt="${recipe.name} Image" class="recipe-image">
...
function displayRecipeDetails() {
    ...
    if (recipeParam && !recipeDetailsContainer.innerHTML.trim()) {
        ...
        detailsDiv.innerHTML = `<div class="recipe-image">
                    <img src="images/${recipe.name.toLowerCase().replace(/\s+/g, '-')}.jpg" alt="${recipe.name} Image">
                                </div>`;
